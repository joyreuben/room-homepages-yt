        ...
        <>
          <section>
            {items.map((item, index) => (
                <article key={item.id} 
                className={slideIndex === index + 1 ? "grid grid-cols-1 lg:grid-cols-2 lg:place-items-center"
                : 'hidden'}  
                >
                    <div className='relative'>
                        ...
                        <ul className='absolute -bottom-2 right-0 flex'>
                            <li><button onClick={prevSlide} className='bg-black hover:bg-neutral-700 transition-all duration-200'>
                              <img src={left} alt="" className='p-6'/>
                            </button></li>
                            <li><button onClick={nextSlide} className='bg-black hover:bg-neutral-700 transition-all duration-200'>
                    ...
                    <div className ="p-8 lg:p-12">
                        ...
                        <button className="flex items-center gap-4 uppercase font-bold
                        hover:opacity-75"
                        style={{
